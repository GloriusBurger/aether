...
public final class AetherConfig {
        ...
        public static final IntEntry HARP_CLICK_DELAY_MIN = Config.integer("harpClickDelayMin", 10).range(0, 300);
        public static final IntEntry HARP_CLICK_DELAY_MAX = Config.integer("harpClickDelayMax", 50).range(0, 300);
